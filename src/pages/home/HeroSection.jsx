...
const closeModal = () => setshowModal(false);
  ...
  return (
    ...
    <p className='text-lg text-gray-600 mb-6'>We create modern, fast, and user-friendly websites that help businesses grow online and attract more customers.</p>
    ...
    
    {
        showModal && (<div className='fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50'>
            ...
            <iframe className='w-full aspect-video'
             width="560" height="315" src="https://www.youtube.com/embed/m79HgtXdFSE?si=dJKQ7R6KO0mZHeZ7" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
