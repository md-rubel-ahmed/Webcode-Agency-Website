...
const Pricing = () => {
    ...
    return (
        <div className='section-container pt-5 mt-5'>
            <HeadingSection heading="Choose Your Plan" subheading="Pricing" description="Select the perfect plan for your business and start building powerful digital solutions today." />
            {/* toggle for early /monthly plan  */}
                    ...
                    pricingPlans.map((plan) => (
                        <div key={plan.name} className='bg-white border rounded-lg overflow-hidden transition-all duration-300 hover:shadow-xl'>
                            ...
                            <div className='p-5 text-center'>
                                ...
                                <p className='text-gray-500 mb-5'> Best for {plan.name.toLowerCase()} </p>
                                {/* pricing  */}
