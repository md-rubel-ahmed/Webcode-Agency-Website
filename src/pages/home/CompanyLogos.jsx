  ...
  return (
    <div className='bg-colorBg'>
      <div className='max-w-screen-2xl container mx-auto py-20 px-5 '>
        <HeadingSection heading="Companies We've Worked With" subheading="Our Trusted Partners" description="We proudly collaborate with innovative companies and trusted brands to deliver high quality digital solutions." />
